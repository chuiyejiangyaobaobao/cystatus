  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> 垂叶叶叶 </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/chuiyejiangyaobaobao",
  home: "https://www.cy00.top",
  email: "mailto:chuiyeaimiku@foxmail.com",
};
</script>
